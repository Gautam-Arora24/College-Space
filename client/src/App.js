...
function App() {
  ...
  async function addAnnouncement(data) {
    ...
    await Axios.post(
      "https://collegespacebackend-production.up.railway.app/college/teacher/announcements",
      {
  ...
  async function getAnnouncementDetailsByInputName(value) {
    let response;
    const url = "https://collegespacebackend-production.up.railway.app/college/teacher/details";
    const data = {
      name: value,
    };
    const headers = {
